 const channels = [
  ...
  {id:27,name:'CNN-News18',category:'News',desc:'International news coverage',thumb:'https://yt3.ggpht.com/SHQE0Y5rb996mAAUmkQZbJdSWj_rcce07GwKk4LTYkf9PKABaWtCEc_a6SjzZPqOgM8pP4kByXE=s48-c-k-c0x00ffffff-no-rj',live:true,streamUrl:'https://www.youtube.com/watch?v=2Ar4yny90fQ',viewers:'42.8K', navigate: false},
  ...
  {id:16,name:'NTV Kenya',category:'News',desc:'Kenyan television network',thumb:'https://yt3.ggpht.com/m3-LYgx3y8CocGJdA1PtfsUPMTLX-MPCVOT3Zbt7ZrEgsBRY4mDTwayx1GQKuDj2qNYowJZlvQ=s48-c-k-c0x00ffffff-no-rj',live:true,streamUrl:'https://www.youtube.com/embed/CJcAxIxIJMo',viewers:'9.2K', navigate: false},
